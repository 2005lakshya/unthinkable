      ...
      <div className="relative w-full max-w-[400px]">
        ...
        <div className="absolute top-[18%] bottom-[12%] left-[10%] right-[10%] z-10 flex flex-col">
            ...
            <div className="text-center mb-6">
              <h2 className={`text-2xl sm:text-3xl font-black uppercase tracking-widest text-black ${t012.className} truncate px-2 leading-none mb-2`}>
                {show.title || 'EVENT'}
              </h2>
              <p className={`text-base font-black uppercase tracking-widest opacity-80 ${nostromoMedium.className}`}>
                {show.type}
              </p>
            </div>
            
            <div className={`flex flex-col gap-3 text-base sm:text-lg font-bold uppercase ${nostromoMedium.className} w-full`}>
              ...
              <div className="flex justify-between border-b-2 border-black/10 pb-2">
                ...
                <span className="text-right truncate max-w-[140px]">{seatLabels}</span>
              </div>
            ...
            <div className="mt-auto flex justify-between items-end w-full pt-4">
              <span className={`text-xl font-black uppercase ${nostromoMedium.className}`}>STATUS</span>
              <span className={`text-2xl font-black uppercase text-[#EF6400] ${ruigslay.className}`}>HELD</span>
            </div>
